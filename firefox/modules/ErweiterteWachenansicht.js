$(function() {
    ...
    function settings(){
        //$(".form-actions").append("<br><a href='#' class='btn btn-default'><span title='Bearbeiten' class='glyphicon glyphicon-option-vertical'></span> EW-Einstellungen</a>");
//
        //$("#iframe-inside-container").before("<textarea></textarea>");
//
        //let response = $.ajax({
        //        type: "GET",
        //        url: '/buildings/3567504',
        //        async: false
        //    }).responseText;
//
        ////$("textarea").text(response);
        //$("textarea").text(response.$("#vehicle_table >> tr").each(function(){ console.log($(this).find("td").text()) }));
    }
